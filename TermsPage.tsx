                ...
                <div className="max-w-[1400px] mx-auto relative z-[20]">
                    ...
                    <article className="prose prose-invert max-w-none">
                        <div className="space-y-12 sm:space-y-16">
                            ...
                            {/* Important Notice */}
                            <div className="p-6 sm:p-8 rounded-2xl sm:rounded-3xl border border-[#D4AF37]/20 bg-[#D4AF37]/5">
                                <p className="text-sm sm:text-base text-[#D4AF37]/90 font-medium">
                                    {t.importantNotice}
                                </p>
                            </div>
                            ...
                            <section>
                                <h2 className="text-2xl sm:text-3xl font-serif font-medium text-gold mb-6">{t.sections.acceptance.title}</h2>
                            ...
                            {/* Section 2: Services */}
                            <section>
                                <h2 className="text-2xl sm:text-3xl font-serif font-medium text-gold mb-6">{t.sections.services.title}</h2>
                                <div className="space-y-4 text-white/80 text-base sm:text-lg leading-relaxed">
                            ...
                            <section>
                                <h2 className="text-2xl sm:text-3xl font-serif font-medium text-gold mb-6">{t.sections.userResponsibilities.title}</h2>
                                <div className="space-y-4 text-white/80 text-base sm:text-lg leading-relaxed">
                                    <p>{t.sections.userResponsibilities.content}</p>
                                    <ul className="list-disc list-inside space-y-2 ml-4">
                                        {t.sections.userResponsibilities.items.map((item, idx) => (
                                            <li key={idx}>{item}</li>
                                        ))}
                                    </ul>
                                </div>
                            ...
                            <section>
                                <h2 className="text-2xl sm:text-3xl font-serif font-medium text-gold mb-6">{t.sections.disclaimer.title}</h2>
                                <div className="space-y-4 text-white/80 text-base sm:text-lg leading-relaxed">
                            ...
                            <section>
                                <h2 className="text-2xl sm:text-3xl font-serif font-medium text-gold mb-6">{t.sections.limitation.title}</h2>
                                <div className="space-y-4 text-white/80 text-base sm:text-lg leading-relaxed">
                                    <p>{t.sections.limitation.content}</p>
                                    <ul className="list-disc list-inside space-y-2 ml-4">
                                        {t.sections.limitation.items.map((item, idx) => (
                                            <li key={idx}>{item}</li>
                                        ))}
                                    </ul>
                                </div>
                            ...
                            {/* Section 6: Risk Disclaimer */}
                            <section>
                                <h2 className="text-2xl sm:text-3xl font-serif font-medium text-gold mb-6">{t.sections.riskDisclaimer.title}</h2>
                                <div className="space-y-4 text-white/80 text-base sm:text-lg leading-relaxed">
                                    <div className="p-6 rounded-2xl border border-[#D4AF37]/20 bg-[#D4AF37]/5">
                                        <p className="font-medium text-[#D4AF37]/90 mb-4">
                                            {t.sections.riskDisclaimer.warning}
                                        </p>
                                        <p>{t.sections.riskDisclaimer.content}</p>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section>
                                <h2 className="text-2xl sm:text-3xl font-serif font-medium text-gold mb-6">{t.sections.intellectualProperty.title}</h2>
                                <div className="space-y-4 text-white/80 text-base sm:text-lg leading-relaxed">
                            ...
                            <section>
                                <h2 className="text-2xl sm:text-3xl font-serif font-medium text-gold mb-6">{t.sections.termination.title}</h2>
                                <div className="space-y-4 text-white/80 text-base sm:text-lg leading-relaxed">
                            ...
                            <section>
                                <h2 className="text-2xl sm:text-3xl font-serif font-medium text-gold mb-6">{t.sections.governingLaw.title}</h2>
                                <div className="space-y-4 text-white/80 text-base sm:text-lg leading-relaxed">
